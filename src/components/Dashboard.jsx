    ...
    <div className="p-8 pt-28 bg-gray-100 min-h-screen">
      {/* <div className="bg-blue-50 p-4 rounded-lg mb-6 shadow-sm">
        <p className="text-sm text-gray-700">
          ...
          <a href="#" className="text-primary hover:text-primaryHover duration-[.3s] font-semibold"> View Premium Plans now</a>
        </p>
      </div> */}
      <div className="bg-white shadow-lg rounded-lg">
        <div className="flex justify-between items-center border-b p-4">
          <div className="flex space-x-8">
            <button className="text-primary duration-[.3s] font-semibold">Internships</button>
        ...
        <div className="p-4">
          ...
          <div className="grid grid-cols-5 gap-4 py-4 text-gray-700">
            <div>Web Development</div>
            <div className="text-primary">Under review</div>
            <div className="text-center">0</div>
            <div className="text-center">
              <button className="text-primary hover:text-primaryHover duration-[.3s] hover:underline">Manage</button>
            </div>
            <div className="text-center">
              <button className="text-primary hover:text-primaryHover duration-[.3s] hover:underline">Share</button>
            </div>
          </div>
        </div>
      </div>
